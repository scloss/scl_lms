...
function getLeaveInfos(preventDefault) {
        ...
        .done(function(leaveInfo) {
            ...
            if (typeof leaveInfo.credit !== 'undefined') {
                ...
                if (duration > credit) {
                    $("#lblCreditAlert").show();
                    //$('#frmLeaveForm').attr('onsubmit','return false;');
                    //$('#submit_button').prop('disabled', true);
                    $("#lblCreditAlert").text("You are exceeding your entitled days. Your available unused leave is: "+credit);
                    //alert("disabledabc");
                    flag1 = 1;
                } 
                else{
                    $("#lblCreditAlert").hide();
                    //$('#frmLeaveForm').attr('onsubmit','return true;');
                    //$('#submit_button').prop('disabled', false);
                    flag1=0;
                    //alert("enabledabc");
                }
                if (duration > 2 && ($("#type").val() == 4 || $("#type").val() == 6)) {
                    $("#lblCasualLeaveAlert").show();
                    //$('#frmLeaveForm').attr('onsubmit','return false;');
                    //$('#submit_button').prop('disabled', true);
                    //alert("disabledxyz");
                    flag2 = 1;
