...
<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
          <a href="<?php echo base_url();?>home" class="brand">&nbsp;<img src="<?php echo base_url();?>assets/images/brand.png" height="45" width="60" style="margin-top:-6px;">&nbsp;SCL LMS</a>
             ...
             <?php if ($is_manager == TRUE) { ?>
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <?php if ($this->config->item('disable_overtime') === TRUE) { ?>
              ...
              <?php } ?>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                      ...
                      <?php } ?>
                      <?php if (($is_hr == TRUE) || ($is_admin == TRUE) || ($this->config->item('hide_global_cals_to_users') === TRUE) ) { ?>
