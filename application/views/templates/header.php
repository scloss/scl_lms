...
<head>
    ...
    <meta charset="utf-8">
    <title><?php echo $title ?> - SCL LMS</title>
    <meta description="SCL leave management system. Workflow of approval; e-mail notifications; calendars; reports; export to Excel and more.">
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>assets/MDI-2.1.19/css/materialdesignicons.min.css">
