    ...
    <div class="row" id="footer">
        ...
        <div class="span4 pull-right">
              <?php switch ($language_code){
                  case 'fr' : echo '<a class="anchor" href="http://172.16.136.35" target="_blank">SCL OSS-NOC</a>'; break;
                  default : echo '<a class="anchor" href="http://172.16.136.35" target="_blank">SCL OSS-NOC</a>'; break;
              } ?>
          &nbsp;v<?php echo $GLOBALS['versionOfJorani'];?>&nbsp;&copy;2019 SCL OSS
        </div>
    </div>
    </div>
