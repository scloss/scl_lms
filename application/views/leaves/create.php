...
<a href="http://172.16.136.80/scl_lms/leaves/counters" class="btn btn-info" target="_blank">Current Leave Balance</a>
<br/>
<div class="row-fluid">
    <div class="span8">
...
echo form_open('leaves/create', $attributes) ?>
    ...
    <div class="alert hide alert-error" id="lblCasualLeaveAlert">
        <?php echo "Casual Leave can not be more than 2 days in row"?>
    </div>
    ...
    <button name="status" id="submit_button" value="2" type="submit" class="btn btn-primary "><i class="mdi mdi-check"></i>&nbsp; Apply</button>
    <br/><br/>
