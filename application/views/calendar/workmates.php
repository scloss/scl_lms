...
<div class="row-fluid">
    <div class="span1"><span class="label"><?php echo lang('Planned');?></span></div>
    <div class="span1"><span class="label label-success"><?php echo lang('Accepted');?></span></div>
    <div class="span1"><span class="label label-warning"><?php echo lang('Requested');?></span></div>
    <div class="span1">&nbsp;</div>
</div>
