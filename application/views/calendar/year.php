    ...
    <tr>
      <td rowspan="2"<?php echo $isCurrentMonth ?' class="currentday-bg"':'';?>><?php echo $month_name; ?></td>
        ...
        foreach ($month->days as $dayNumber => $day) {
            ...
            if (($display == 4 || $display == 5) && strpos($type,'National')===False) echo '<td title="' . $type .'" class="dayoff'.($class?' '.$class:'').'">&nbsp;</td>';
            if (($display == 4 || $display == 5) && strpos($type,'National')!==False) echo '<td title="' . $type .'" class="dayoff-national-holiday'.($class?' '.$class:'').'">&nbsp;</td>';
      ...
      <?php //Fill
      if ($pad_day <= 31) echo '<td colspan="' . (32 - $pad_day) . '" rowspan="2" style="background-color:#FFF;">&nbsp;</td>';
        ?>
    </tr>
    <tr>
        ...
        foreach ($month->days as $dayNumber => $day) {
            ...
            if (($display == 4 || $display == 6) && strpos($type,'National')===False) echo '<td title="' . $type .'" class="dayoff'.($class?' '.$class:'').'">&nbsp;</td>';
            if (($display == 4 || $display == 6) && strpos($type,'National')!==False) echo '<td title="' . $type .'" class="dayoff-national-holiday'.($class?' '.$class:'').'">&nbsp;</td>';
