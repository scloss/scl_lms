...
class Pages extends CI_Controller {
    ...
    public function view($page = 'home') {
        ...
        $data['summary'] = $this->leaves_model->getLeaveBalanceForEmployee($this->user_id, FALSE, date("Y-m-d"));
        $data['leaves'] = $this->leaves_model->getPendingLeavesOfEmployee($this->session->userdata('id'));
